...
\par
Picture below attempts to describe an example of different responsibility zones related to IaaS architechture.
\begin{figure}
    \includegraphics[width=\linewidth]{thesis_iaas.jpg}
