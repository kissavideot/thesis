...
Tahan pitaa saada joku karkea kuvaus cloud computingista, vahan samaan tyyliin kuin mita on tuossa general overview of cloud -kappaleessa, mut viela generaalimpi?
\par
...
\par
Controversy of cloud computing is further illustrated by Tim Mather, Subra Kumaraswamy and Shahed Latif in their book Cloud security and privacy. They do it using the familiar "mind the gap" -sign seen (and heard) in the London subway. Principle is that while we constantly hear the choir of "cloud computing good" we also get to hear the "could security bad" verse. Mind the gap meaning that one has to watch his step. Yet it is apparently not clear what is wrong with the cloud security.(Tim Mather, Subra Kumaraswamy and Shahed Latif 2009). This thesis tries to find answers to what that might mean and what should be taken into an account when evaluating ones cloud posture.
\subsection{Objective of the study}
Ultimate goal of the study was to create self-assessment questionaire for cloud computing security.
\subsection{Methods of the study}
By answering to a question such as "what kind of information we're trying to come up with this research?" we can get a reasonable research method (Vilkka 2015).
The goal of this thesis was to come up with a self-assessment criteria to evaluate ones cloud posture in terms of security.
To this end the research was done by first doing qualitative research utilizing literature avaible to us and the topics other researchers had found noteworthy, followed by the practical part that was based on the findings from the first part.
\par
