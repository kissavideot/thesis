...
While it has been acknowledged that risks and uncertainties exist in the global supply chains, the risk management as such has not played such a significant role in the management of supply chain. Risks in the supply chain may come in variety of forms, such as environmental, ethical or social conduct resulting in a worker strike, or malfunctions in the manufacturing procedure, all these have direct impact on the ability to deliver the service or product. (Harilainen,2014).
Information sharing is within the supply chain management is essential component and it is critical in improving the capability and gain competatite advantage, to this end it is not uncommon for organization to be reluctant to share their supply chain information. These global supply chains are exposed to various types of risks that stem from the increasing globalization making them vulnerable as they rely in Internet for transport. Based on statement by U.S Government accountability office from 2012 there are five general threat factors for supply chain:
\begin{description}
	...
	\item[$\bullet$ Relying] on unqualified or malevolent service provider.
...
\end{description}
Supply chain is a critical element in a modern organization and the success of failure of business organizations depends on the gains made from the effective supply chain.(Aiguokhian, 2013)
\par
To this end, customer would do wisely to confirm how the cloud service provider implements these policies in their supply chain. Same is true for the internal processes of the customer. 
\subsubsection{Human factor in security and the cycle of deception}
There is a complete class of vulnerabilities related to the human factor in the security landscape, goal of these attacks being to induce the victim to relay information or execute activities they are not supposed to either release or perform.
