...
Unlike with public cloud, multitenancy is slightly less of an issue in private cloud, infact private cloud on its own could be seen as an approach to solve the multitenancy issue. (Bond, 2018)
...
Oxford dictionary definition of audit states that the audit is an official inspection of entitys accounts by an independent auditor. (Oxford dictionaries, 2018). We believe that the aforementioned statements highligh the difference of audit and self-assessment. 
\section{Conclusions}
\end{document}
