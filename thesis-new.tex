...
\bibitem{Reasons to Think About Cloud Computing}
	...
	Bachelor's thesis.
        Metropolia.
	Retreived on 27.3.2019 from http://urn.fi/URN:NBN:fi:amk-201303243590.
\bibitem{Supply Chain Security Using RSA Algorithm}
	...
	Retreived on 27.3.2019 from http://urn.fi/URN:NBN:fi:amk-201302052078.
\bibitem{Systematic Service Level Agreement SLA data management}
	...
	Retreived on 27.3.2019 from https://archive-ouverte.unige.ch/unige:40738.
...
\bibitem{Applied Information Security: A Hands-on Approach}
	...
	Retreived on 27.3.2019 from https://doi.org/10.1007/978-3-642-24474-2.
...
\bibitem{A Formal Security Analysis of the Signal Messaging Protocol}
	...
	Retreived on 27.3.2019 from https://eprint.iacr.org/2016/1013.pdf.
\bibitem{Directive 95/46/EC}
	European Commission.
	1995.
	\textit{Directive 95/46/EC}
	Retreived on 27.3.2019 from https://ec.europa.eu/eip/ageing/standards/ict-and-communication/data/directive-9546ec\_en.
...
\bibitem{Managing Supplier Sustainability Risk }
	...
	Retreived on 27.3.2019 from https://helda.helsinki.fi/handle/10138/44842.
\bibitem{Practical and Robust Secure Logging from Fault-Tolerant Sequential Aggregate Signatures}
	...
	\textit{Practical and Robust Secure Logging from Fault-Tolerant Sequential Aggregate Signatures}.
        Springer.
	Retreived on 27.3.2019 from https://eprint.iacr.org/2017/949.pdf.
\bibitem{Safe and effective nuclear power plant life cycle management towards decommissioning}
	...
	International Atomic Energy Agency.
	Retreived on 27.3.2019 from https://www-pub.iaea.org/MTCD/Publications/PDF/te\_1305\_web.pdf.
...
\bibitem{Data Deduplication for Data Optimization for Storage and Network Systems}
	...
	\textit{Data Deduplication for Data Optimization for Storage and Network Systems}
        Springer.
	Retreived on 27.3.2019 from https://doi.org/10.1007/978-3-319-42280-0.
\bibitem{Guide to Computer Network Security}
        Kizza, M. J.
        2012.
        \textit{Guide to Computer Network Security}.
	Springer.
	Retreived on 27.3.2019 from https://doi.org/10.1007/978-1-4471-6654-2.
...
\bibitem{The experiences with and opinions on self-assessment among students and their teachers}
	...
	Retreived on 27.3.2019 from http://urn.fi/URN:NBN:fi:jyu-201205241727.
...
\bibitem{LOCKING DOWN LOG FILES:  ENHANCING NETWORK SECURITY BY PROTECTING LOG FILES }
	...
	Retreived on 27.3.2019 from http://iacis.org/iis/2006/Lantz\_Hall\_Couraud.pdf.
\bibitem{IT Security Risk Management in the Context of Cloud Computing}
	...
	Retreived on 27.3.2019 from https://doi.org/10.1007/978-3-658-11340-7.
...
\bibitem{Defense in Depth: Foundations for Secure and Resilient IT Enterprises}
	...
	Retreived on 27.3.2019 from http://citeseerx.ist.psu.edu/viewdoc/download?rep=rep1\&type=pdf\&doi=10.1.1.208.737. 
...
\bibitem{INFORMATION SECURITY MANAGEMENT IN ORGANIZATIONS}
	...
	Retreived on 27.3.2019 from http://urn.fi/URN:NBN:fi:amk-2015061613437.
\bibitem{Pro data backup and recovery}
        Nelson, S.
        2011.
        \textit{Pro data backup and recovery}.
	Apress.
	Retreived on 27.3.2019 from https://www.apress.com/us/book/9781430226628.
\bibitem{Securing Information Assets: Understanding, Measuring and Protecting against Social Engineering Attacks}
	...
	Retreived on 27.3.2019 from http://www.diva-portal.org/smash/get/diva2:200190/FULLTEXT01.pdf.
\bibitem{GDPR}
	\textit{Official GDPR website.}
	Retreived on 27.3.2019 from https://ec.europa.eu/commission/priorities/justice-and-fundamental-rights/data-protection/2018-reform-eu-data-protection-rules\_en.
\bibitem{The risks of not having business internet redundancy}
	Packetworks.
	\textit{The risks of not having business internet redundancy}
	Retreived on 27.3.2019 from http://www.packetworks.net/blog/the-risks-of-not-having-business-internet-redundancy.htm.
\bibitem{Distributed firewalls: how badly do you want to fail?}
	Pepelnjak, I.
	\textit{Distributed firewalls: how badly do you want to fail?}
	Retreived on 27.3.2019 from https://blog.ipspace.net/2011/04/distributed-firewalls-how-badly-do-you.html.
\bibitem{Survey on Secure Search Over Encrypted Data on the Cloud}
	...
	Retreived on 27.3.2019 from https://arxiv.org/pdf/1811.09767.pdf.
...
\bibitem{Key management deployment guide : using the IBM Enterprise key management foundation}
	...
	\textit{Key management deployment guide : using the IBM Enterprise key management foundation}.
        2014.
	IBM Redbooks.
	Retreived on 27.3.2019 from http://www.redbooks.ibm.com/redbooks/pdfs/sg248181.pdf.
...
\bibitem{Cloud computing, Tieto cloud server model}
	...
	Retreived on 27.3.2019 from http://urn.fi/URN:NBN:fi:amk-2013060613360.
\bibitem{Cloud Computing and Security}
	...
	Springer.
	Retreived on 27.3.2019 from https://link.springer.com/book/10.1007/978-3-319-48671-0.
\bibitem{Service Repository for Cloud Service Consumer Life Cycle Management }
	...
	Retreived on 27.3.2019 from https://link.springer.com/content/pdf/10.1007\%2F978-3-319-24072-5\_12.pdf.
...
\bibitem{Cloud Computing, Security, Privacy in New Computing Environments,2016}
	...
	Retreived on 27.3.2019 from https://link.springer.com/content/pdf/10.1007\%2F978-3-319-69605-8.pdf.
...
\bibitem{WAVNet: Wide-Area Network Virtualization Technique for Virtual Private Cloud}
	...
	2011.
        ...
        IEEE.
	Retreived on 27.3.2019 from https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=\&arnumber=6047197.
\bibitem{Security for Cloud Storage systems}
	...
	\textit{Security for Cloud Storage systems}.
        Springer.
	Retreived on 27.3.2019 from https://doi.org/10.1007/978-1-4614-7873-7.
\bibitem{Building the infrastructure for cloud security: a solutions view}
	...
	\textit{Building the infrastructure for cloud security: a solutions view}
        Apress
	Retreived on 27.3.2019 from https://doi.org/10.1007/978-1-4302-6146-9.
\end{thebibliography}
