...
\par
Definition of risk could be illustrated as an event where the bad thing happens to something we care about. Risk is built of two components: impact and likelihood.(PALAA)
