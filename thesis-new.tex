...
\begin{description}
	\item[$\bullet$ Is] there a policy in-place that prioritizes safety, and if that policy is aligned with the values and requirements of the customer?
	\item[$\bullet$ Is] this change management policy utilized to in systematic and transparent fashion?
	\item[$\bullet$ Are] all the required resources to make change available?
	\item[$\bullet$ Is] proper analysis done that justifies the change, including the risks therein?
	\item[$\bullet$ Is] there a machanism in-place that allows management to review the changes regularly?
	\item[$\bullet$ Is] there a communication plan that to keep all the parties informed?
	\item[$\bullet$ Is] there a system and criterion to evaluate if the change was successful?
\end{description}
Many organizations are having to deal with the pressure to change. When properly managed, these changes could improve security, reliability and also, the competative aspects of an organization, all the way from the initial planning stages to the decommissioning phase. (International atomic energy agency 2001)
...
\begin{description}
	...
	\item[$\bullet$ Changes done by all parties] are tracked.
\end{description}
...
\section{Conclusions}
Even though the cloud as a technology has been existing for several years, there are still surprisingly little material available in terms of audit criterion, this became a reality when autho
rs started to gather material for this thesis. Especially the security in cloud seems to be investigated quite little, even though there is definitely need for this. However, as there was rat
her limited material to use for this cloud security survey, especially given the confidential nature of the questionnaire, the shortcomings were seen more like a challenge and something that
we took as a sign of need for the thesis.
 The shortage of material wasn't the only challenge as the material we found was often written from different standpoint. As this thesis was made by two technically oriented professionals, the
 lack of real-life experience of many writers was quite disturbing. Nonetheless, from the material a few real treasures were found, such as Halpert's book of cloud security and privacy, also
there are some academic material that discusses cloud in particularly from descriptive stand point, such as the master's thesis of Saara Suikkanen that provides clear descriptions and definit
ions for basic concepts of the cloud. While not maybe 100% cloud related the IETF RFCs from the standards track continue to be invaluable source of reference information, especially when eval
uating if a solution proposed by service provider is compliant with the standards. Also, as our focus was strongly from the audit perspective, many of the sources seemed quite shallow and eve
n naive.
\par
Although the aging criteria in Katakri 2015 was a big motivator on this, it was clear that it wouldn't fully benefit the target audience as such, as many of the criterion in it are too comple
x, controversial or just simply too tight for trivial business use-cases. Nevertheless, during the writing process of this thesis, there was an ongoing debate with a cloud criteria going on i
n Traficom, which we provided some feedback to.
Another motivator was the Cloud Alliance's form. We went through it with much detail, although this work didn't find its way to this thesis. Nevertheless, many of the core topics can be found
 in here. The biggest challenge with the Cloud Alliance's material is the mere size of it: dozens and dozens of criterion makes it purely exhausting. One of the key aspects to this work was t
o avoid coming up with too technical audit criterion, this was deemed as especially important in order to avoid non-technical parties being "scared" with audit text. Authors tried to compensa
te on this with more detailed introduction to cryptography and the availability aspects within networking.
In the end, we are quite happy with some of the criterion, but there are some flaws also. We managed to keep the criteria in a manageable amount, yet in our material some obvious details were
 neglected, similar to network time protocol or precision time protocols, as it is important particularly in logs. In addition to missing network time protocol, also and protecting administra
tion connections, which is one of the top three things to secure, is neglected, yet a knowledgeable person would most likely include this into defense-in-depth. Although we would have wanted
to add several details here and there, we left them out because of the fact that these were not mentioned in the source material, yet a skilled technician can understand that at least these t
wo examples are a part of logging and encryption/defense in depth.
\par
During the time of writing, Traficom's cloud criteria was worked upon. As one can guess from Katakri, certain administrative issues are covered there in more detail as well as personnel relat
ed issues, as these requirements often come strongly from legislation e.g. the "need to know" principle. For the same reason data classification and separation is emphasized. These difference
s are very natural and are to be expected. Yet, topics like secure development conventions missing in this thesis is a bit annoying fact, though it is natural when judging the source material
 - secure development conventions aren't seen as a cloud related topic but instead, a software development related topic. A major flaw in all criterias and assessments is their long update pr
ocedure - they do now react to new emerging threats very fast. It is a hard topic to figure out how to expect or even demand something that is during the publication time completely vague. Ma
ybe these could be derived from awareness, roles and training, but this would still be quite superficial.
\par
In a cloud environment, as well as actually any environment that is not very simple and thus self-evident, it is not possible to achieve perfect security. The correct way of thinking might be
 to mix both technical and contractual details to gain sufficient level of trust, this viewpoint can be in our opinion derived from lot of the cloud material available, as this thesis has pin
pointed several issues related to that and, and also from the fact that e.g. the cloud alliance cloud criteria and Traficom's work address legislative and contractual details quite strongly.
As new technologies emerge in huge speed and there is often a lot of pressure to adapt these to different environments, one should probably try to think modern IT systems from the business po
int of view, not just from technological viewpoint. In this possibilities, contracts and different actors playing together can create a secure and prudent environment.
...
\bibitem{Reasons to Think About Cloud Computing}
	...
	Bachelor's thesis.
        Metropolia.
	Retreived on 10.11.2018 from http://urn.fi/URN:NBN:fi:amk-201303243590.
\bibitem{Supply Chain Security Using RSA Algorithm}
	...
	Retreived on 28.1.2019 from http://urn.fi/URN:NBN:fi:amk-201302052078.
\bibitem{Systematic Service Level Agreement SLA data management}
	...
	Retreived on 10.11.2018 from https://archive-ouverte.unige.ch/unige:40738.
...
\bibitem{Key management deployment guide : using the IBM Enterprise key management foundation}
	...
	\textit{Key management deployment guide : using the IBM Enterprise key management foundation}.
        2014.
	IBM Redbooks.
	Retreived on 10.1.2019 from http://www.redbooks.ibm.com/redbooks/pdfs/sg248181.pdf.
\bibitem{AWS Managed VPN Connections}
	AWS Whitepaper.
	2019.
	\textit{AWS Managed VPN Connections}
	Amazon.
	Retreived on 28.3.2019 from https://docs.aws.amazon.com/aws-technical-content/latest/aws-vpc-connectivity-options/aws-managed-vpn-network-to-amazon.html
\bibitem{Applied Information Security: A Hands-on Approach}
	...
	Retreived on 18.1.2019 from https://doi.org/10.1007/978-3-642-24474-2.
\bibitem{The Tao of Network Security Monitoring Beyond Intrusion Detection}
	...
	https://isbnsearch.org/isbn/9780321246776.
...
\bibitem{Cloud security}
	...
	O'reilly media, inc.
	https://www.oreilly.com/library/view/cloud-security/9781492033790/.
\bibitem{Cloud Computing: Principles and Paradigms}
	...
	John Wiley \& Sons.
	https://isbnsearch.org/isbn/9780470887998.
\bibitem{Accountability and security in the cloud : First Summer School, Cloud Accountability Project, A4Cloud, Malaga, Spain, June 2-6, 2014, Revised Selected Papers and Lectures}
	...
	https://isbnsearch.org/isbn/9783319171982.
\bibitem{Accountability and security in the cloud : First Summer School, Cloud Accountability Project, A4Cloud, Malaga, Spain, June 2-6, 2014, Revised Selected Papers and Lectures}
        Cayirci, E.
	2014.
...
\bibitem{Prepare for the Worst, Plan for the Best: Disaster Preparedness and Recovery for Small Businesses}
	...
	John Wiley \& Sons.
	https://isbnsearch.org/isbn/9780470170915.
\bibitem{A Formal Security Analysis of the Signal Messaging Protocol}
	...
	Retreived on 10.1.2019 from https://eprint.iacr.org/2016/1013.pdf.
\bibitem{Directive 95/46/EC}
	European Commission.
	1995.
	\textit{Directive 95/46/EC}
	Retreived on 9.1.2019 from https://ec.europa.eu/eip/ageing/standards/ict-and-communication/data/directive-9546ec\_en.
\bibitem{Rethinking Enterprise Storage: A Hybrid Cloud Model}
        Farley, M.
        2013.
	\textit{Rethinking Enterprise Storage: A Hybrid Cloud Model}
        Microsoft Press.
	https://isbnsearch.org/isbn/9780735679603.
\bibitem{Cloud VPN Overview}
	Google cloud documentation.
	2019.
	\textit{Cloud VPN Overview}.
	Retreived on 28.3.2019 from https://cloud.google.com/vpn/docs/concepts/overview.
\bibitem{Auditing Cloud Computing: A Security and Privacy Guide}
        Halpert, B.
        2011.
	\textit{Auditing Cloud Computing: A Security and Privacy Guide}.
	John Wiley \& Sons.
	https://isbnsearch.org/isbn/9780470874745.
\bibitem{Managing Supplier Sustainability Risk }
	...
	Retreived on 28.1.2019 from https://helda.helsinki.fi/handle/10138/44842.
\bibitem{Practical and Robust Secure Logging from Fault-Tolerant Sequential Aggregate Signatures}
	...
	\textit{Practical and Robust Secure Logging from Fault-Tolerant Sequential Aggregate Signatures}.
        Springer.
	Retreived on 18.1.2019 from https://eprint.iacr.org/2017/949.pdf.
\bibitem{Safe and effective nuclear power plant life cycle management towards decommissioning}
	...
	International Atomic Energy Agency.
	Retreived on 21.1.2019 from https://www-pub.iaea.org/MTCD/Publications/PDF/te\_1305\_web.pdf.
\bibitem{Managing change in nuclear utilities}
	International Atomic Energy Agency.
	2001.
	\textit{Managing change in nuclear utilities}
	International Atomic Energy Agency.
	Retreived on 27.3.2019 from https://www-pub.iaea.org/MTCD/Publications/PDF/te\_1226\_prn.pdf
\bibitem{Network Security Auditing}
        Jacksoin, C.
        2010.
       	\textit{Network Security Auditing}.
	Cisco Press.
	https://isbnsearch.org/isbn/9781587053528.
\bibitem{Cloud Computing}
        Jamsa, K.
        2012.
        \textit{Cloud Computing}.
	Jones \& Bartlett Learning.
	https://isbnsearch.org/isbn/1449647391.
\bibitem{Cloud Computing Security}
        John, R. V.
        2016.
        \textit{Cloud Computing Security}.
	CRC Press.
	https://doi.org/10.1201/9781315372112.
\bibitem{Architecting the Cloud}
	...
	John Wiley \& Sons.
	Retreived on 25.9.2018 from http://common.books24x7.com.ezproxy.jamk.fi:2048/toc.aspx?bookid=62597.
\bibitem{Data Deduplication for Data Optimization for Storage and Network Systems}
	...
	\textit{Data Deduplication for Data Optimization for Storage and Network Systems}
        Springer.
	Retreived on 11.1.2019 from https://doi.org/10.1007/978-3-319-42280-0.
\bibitem{Guide to Computer Network Security}
        Kizza, M. J.
        2012.
        \textit{Guide to Computer Network Security}.
	Springer.
	Retreived on 15.1.2019 from https://doi.org/10.1007/978-1-4471-6654-2.
\bibitem{The Cloud Security Ecosystem}
	...
	Syngress.
	https://isbnsearch.org/isbn/9780128015957.
\bibitem{The experiences with and opinions on self-assessment among students and their teachers}
	...
	Retreived on 10.1.2019 from http://urn.fi/URN:NBN:fi:jyu-201205241727.
\bibitem{Cloud security: A comprehensive guide to secure cloud computing}
	...
	John Wiley \& Sons.
	https://isbnsearch.org/isbn/9780470589878.
\bibitem{LOCKING DOWN LOG FILES:  ENHANCING NETWORK SECURITY BY PROTECTING LOG FILES }
	...
	Retreived on 18.1.2019 from http://iacis.org/iis/2006/Lantz\_Hall\_Couraud.pdf.
\bibitem{IT Security Risk Management in the Context of Cloud Computing}
	...
	Retreived on 7.1.2019 from https://doi.org/10.1007/978-3-658-11340-7.
\bibitem{Cloud Security and Privacy}
	...
	\textit{Cloud Security and Privacy}.
        O'Reilly Media, Inc.
	https://isbnsearch.org/isbn/9780596802769.
\bibitem{Defense in Depth: Foundations for Secure and Resilient IT Enterprises}
	...
	Retreived on 22.1.2019 from http://citeseerx.ist.psu.edu/viewdoc/download?rep=rep1\&type=pdf\&doi=10.1.1.208.737. 
\bibitem{Understanding PaaS}
        McGrath, M. P.
        2012.
	\textit{Understanding PaaS}.
        O'Reilly Media, Inc.
	https://isbnsearch.org/isbn/9781449323424.
\bibitem{CyberWar, CyberTerror, CyberCrime and CyberActivism}
	Mehan, J.
	2014.
	\textit{CyberWar, CyberTerror, CyberCrime and CyberActivism}.
	IT Governance Publishing.
	https://isbnsearch.org/isbn/9781849285711.
\bibitem{Azure VPN Gateway Documentation}
	Microsoft Azure.
	2019.
	\textit{Azure VPN Gateway Documentation}
	Retreived on 28.3.2019 from https://docs.microsoft.com/en-us/azure/vpn-gateway/.
\bibitem{INFORMATION SECURITY MANAGEMENT IN ORGANIZATIONS}
	...
	Retreived on 28.1.2019 from http://urn.fi/URN:NBN:fi:amk-2015061613437.
\bibitem{Pro data backup and recovery}
        Nelson, S.
        2011.
        \textit{Pro data backup and recovery}.
	Apress.
	Retreived on 9.1.2019 from https://www.apress.com/us/book/9781430226628.
\bibitem{Securing Information Assets: Understanding, Measuring and Protecting against Social Engineering Attacks}
	...
	Retreived on 28.1.2019 from http://www.diva-portal.org/smash/get/diva2:200190/FULLTEXT01.pdf.
\bibitem{GDPR}
	\textit{Official GDPR website.}
	Retreived on 7.1.2019 from https://ec.europa.eu/commission/priorities/justice-and-fundamental-rights/data-protection/2018-reform-eu-data-protection-rules\_en.
\bibitem{The risks of not having business internet redundancy}
	Packetworks.
	\textit{The risks of not having business internet redundancy}
	Retreived on 3.4.2018 from http://www.packetworks.net/blog/the-risks-of-not-having-business-internet-redundancy.htm.
\bibitem{Distributed firewalls: how badly do you want to fail?}
	Pepelnjak, I.
	\textit{Distributed firewalls: how badly do you want to fail?}
	Retreived on 3.4.2018 from https://blog.ipspace.net/2011/04/distributed-firewalls-how-badly-do-you.html.
\bibitem{Survey on Secure Search Over Encrypted Data on the Cloud}
	...
	Retreived on 11.1.2019 from https://arxiv.org/pdf/1811.09767.pdf.
...
\bibitem{Cloud computing, Tieto cloud server model}
	...
	Retreived on 10.11.2018 from http://urn.fi/URN:NBN:fi:amk-2013060613360.
\bibitem{Cloud Computing and Security}
	...
	Springer.
	Retreived on 9.1.2019 from https://link.springer.com/book/10.1007/978-3-319-48671-0.
\bibitem{Service Repository for Cloud Service Consumer Life Cycle Management }
	...
	Retreived on 21.1.2019 from https://link.springer.com/content/pdf/10.1007\%2F978-3-319-24072-5\_12.pdf.
\bibitem{Tutki ja kehitä}
	Vilkka, H.
	2015.
	\textit{Tutki ja kehitä}.
	PS-Kustannus.
\bibitem{Enterprise Cloud Security and Governance}
	...
	Packt Publishing.
	https://isbnsearch.org/isbn/9781788299558.
\bibitem{Cloud Computing, Security, Privacy in New Computing Environments,2016}
	...
	Retreived on 3.1.2019 from https://link.springer.com/content/pdf/10.1007\%2F978-3-319-69605-8.pdf.
\bibitem{Disappearing Cryptography, 3rd Edition}
        Wayner, P.
        2009.
	\textit{Disappearing Cryptography, 3rd Edition}.
        Morgan Kaufmann.
	https://isbnsearch.org/isbn/9780123744791.
\bibitem{Securing the Cloud}
        Winkler, V.
	2011.
	\textit{Securing the Cloud}.
        Syngress.
	https://isbnsearch.org/isbn/9781597495929.
\bibitem{WAVNet: Wide-Area Network Virtualization Technique for Virtual Private Cloud}
	...
	2011.
        ...
        IEEE.
	Retreived on 15.1.2019 from https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=\&arnumber=6047197.
\bibitem{Security for Cloud Storage systems}
	...
	\textit{Security for Cloud Storage systems}.
        Springer.
	Retreived on 11.1.2019 from https://doi.org/10.1007/978-1-4614-7873-7.
\bibitem{Building the infrastructure for cloud security: a solutions view}
	...
	\textit{Building the infrastructure for cloud security: a solutions view}
        Apress
	Retreived on 3.12.2018 from https://doi.org/10.1007/978-1-4302-6146-9.
\end{thebibliography}
